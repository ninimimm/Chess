...
class MoveFigures:
    ...
    def is_check(self, enemy_to_king, dict_cages, tuple_coordinate):
        for enemy_figure in enemy_to_king:
            if any(cord in self.dict_figure_moves[enemy_figure.name] for cord in tuple_coordinate):
                ...
                enemy_figure_moves = self.dict_figure_moves[enemy_figure.name]
            for cord in enemy_figure_moves:
    ...
    def get_possible_defense_moves(self, color, dict_cages):
        ...
        for move in piece.get_moves(piece.coordinate, dict_cages[piece.coordinate], dict_cages):
            ...
            if not self.is_check(self.enemy_figures, dict_cages, (start_cord, move)):
